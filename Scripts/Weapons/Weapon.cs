...
public abstract class Weapon : Sprite
{
	...
	/// </summary>
	public Bullet SpawnBullet(OwnerTag bulletOwner, Vector2 atPos, Vector2 direction, float bulletSpeed = 100f)
	{
	...
	public Bullet SpawnBullet(OwnerTag bulletOwner, Vector2 atPos, float angleDegrees, float bulletSpeed = 100f)
	{
